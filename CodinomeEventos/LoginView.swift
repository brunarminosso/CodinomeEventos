...
class LoginView: UIViewController, LoginButtonDelegate {
    ...
    override func viewDidLoad() {
        ...
        emailText.layer.cornerRadius = raio
        emailText.layer.borderWidth = borderWidth
        ...
        senhaText.layer.cornerRadius = raio
        senhaText.layer.borderWidth = borderWidth
        ...
        botaoLogin_visual.layer.cornerRadius = 10.0
