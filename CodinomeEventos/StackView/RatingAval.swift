...
@IBDesignable class RatingAval: UIStackView {
...
//        print("Button pressed!")
    ...
    private func setupButtons () {
        ...
        let estrelavaziapequena = UIImage(named: "estrela_vazia_pq", in: bundle, compatibleWith: self.traitCollection)
        let estrelacheiapequena = UIImage(named: "estrela_cheia_pq", in: bundle, compatibleWith: self.traitCollection)
        //        let estrelaVazia = UIImage(named: "estrela_vazia", in: bundle, compatibleWith: self.traitCollection)
        
        for _ in 0..<starCount {
            let button = UIButton()
            
            button.setImage(estrelavaziapequena, for: .normal)
            button.setImage(estrelacheiapequena, for: .selected)
